...
项目地址： [cs-exam](https://jmaxhu.gitbook.io/cs-exam/)

# Table of contents

- [关于](README.md)
- [计算机与网络基础知识](fundation/index.md)
  - [计算机基础](fundation/computer/index.md)
  - [操作系统](fundation/os/index.md)
    - [磁盘调度算法](fundation/os/hd_head_move.md)
    - [进程控制块(PCB)](fundation/os/pcb.md)
...
- [UML](uml/index.md)
  - [4+1 视图](uml/four_one.md)
- [软件架构设计](arct/index.md)
- [XML](xml/index.md)
- [面向构件的软件设计](comp/index.md)
- [其它](other/index.md)
